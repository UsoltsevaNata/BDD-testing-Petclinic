...
This repository contains BDD test suites for the Spring PetClinic application, comparing three frameworks: Cucumber, Enhanced Gherkin, and ConcordiaLang. The work was completed as part of the practical training at SPbPU Institute of Computer Science and Cybersecurity (SPbPU ICSC).
